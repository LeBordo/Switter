...
class SwitsControllerTest < ActionController::TestCase
  ...
  test "should create swit" do
    assert_difference('Swit.count') do
      post :create, swit: { author: @swit.author, body: @swit.body, likes: @swit.likes, unlike: @swit.unlike }
    end
  ...
  test "should update swit" do
    patch :update, id: @swit, swit: { author: @swit.author, body: @swit.body, likes: @swit.likes, unlike: @swit.unlike }
    assert_redirected_to swit_path(assigns(:swit))
  end
